...
ggsave("output/regional_broad_qa1.png",   plot = plots_by_vegetation[[1]], bg = "white", width = width, height = height)
ggsave("output/regional_conifer_qa1.png", plot = plots_by_vegetation[[2]], bg = "white", width = width, height = height)
